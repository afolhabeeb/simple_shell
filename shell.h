...
/* get_builtin */
int (*get_builtin(char *cmd))(data_shell *shell_data);
...
/* shell_errors2.c */
char *errors_get_alias(char **args);
char *env_error(data_shell *shell_data);
char *errors_syntax(char **args);
char *errors_permission(char **args);
